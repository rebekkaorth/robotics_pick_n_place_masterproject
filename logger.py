...
This file is equivalent to the logger.py file in the project names above.
...
class Logger:
    ...
    def save_transition(self, iteration, transition):
        ...
        cv2.imwrite(os.path.join(self.transitions_directory, 'data', '%06d.1.depth.png' % (iteration)),
