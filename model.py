...
This file is equivalent to the models.py file in the project names above with adjustments according to the project at
hand.
...
"""
potentially decide on one of the models 
